        ...
        <div class="container">
            ...
            <div class="box">
               <form action="" method="POST" enctype="multipart/form-data">
                   ...
                   <textarea class="input-control" name="deskripsi" placeholder="deskripsi"><?php echo $p->description ?></textarea><br />
               ...
               <?php
                   if(isset($_POST['submit'])){
					...
					$update = mysqli_query($conn, "UPDATE tb_image SET
										   ...
										   admin_name          = '".$user."',
										   image_name          = '".$namagambar."',
										   description   = '".$deskripsi."',  /* Pastikan nama kolom benar */
										   status        = '".$status."'
