...
<body>
    ...
    <header>
        <div class="container">
        <h1><a href="dashboard_admin.php">WEB GALERI FOTO HEWAN</a></h1>
        <ul>
                ...
                <table border="1" cellspacing="0" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           <td><a href="foto/<?php echo $row['image_file']?>" target="_blank"><img src="foto/<?php echo $row['image_file']?>" width="50px"></a></td>
